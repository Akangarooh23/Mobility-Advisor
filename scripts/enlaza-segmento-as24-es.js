/**
 * Le dice al orquestador español a quién tiene que llamar.
 *
 *   npm run enlaza-segmento-es
 *
 * Busca «AutoScout24 – Segmento» en la base de n8n, coge su id, lo escribe en
 ...
 * literal REEMPLAZA_CON_ID_DEL_WORKFLOW_SEGMENTO, y un id mal pegado da
...
const GENERADOR = path.join(__dirname, "genera-scraper-as24-es.js");
const NOMBRE = "AutoScout24 – Segmento";
...
if (!filas.length) {
  ...
  console.error("Impórtalo primero (n8n-workflows/autoscout24-segmento.json) y vuelve a lanzar esto.");
  process.exit(1);
}
if (filas.length > 1) {
...
console.log("\n  Ahora reimporta n8n-workflows/autoscout24-scraper-offers.json en n8n.");
