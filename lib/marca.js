...
const MARCA = {
  ...
  /*
   * El teléfono, en un solo sitio y por lo mismo que todo lo demás.
   *
   * Estaba escrito a mano en tres pantallas y con **dos valores distintos**: la
   * ficha del portal ya llevaba el bueno y la página de Contacto seguía
   * enseñando un `600 000 000` de relleno, en producción, con su enlace de
   * WhatsApp a un número que no es de nadie. Quien entraba por Contacto no
   * tenía forma de llamarnos.
   *
   * Van los dos formatos porque hacen falta los dos y no se derivan bien el uno
   * del otro: `wa.me` quiere el número pegado con prefijo y sin signos, y a la
   * persona hay que enseñárselo separado.
   */
  telefono: "+34 684 717 736",
  telefonoWhatsapp: "34684717736",
