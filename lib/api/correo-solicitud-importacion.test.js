...
describe("el correo de la solicitud de importación", { concurrency: 1 }, () => {
  ...
  test("cuando todo va bien, se dice que sí", async () => {
    ...
    // El coche entero más nuestro fee. No un porcentaje: el coche se lo compra
    // él al vendedor alemán, así que ese dinero tiene que estar depositado.
    const { FEE_POPCAR } = require("../coste-importacion.js");
    assert.equal(r.deposit, 9000 + FEE_POPCAR);
  });
});
