 ...
 *
 * El representante de cada grupo es **el más barato**, y a igualdad de precio
 * el de id menor, que es estable: sin un desempate fijo la misma búsqueda
 * devolvería una tarjeta distinta cada vez.
 *
...
${sqlInterior}
  ...
  SELECT ${huellaSql("f")} ,
         ...
         (array_agg(f.id ORDER BY f.price ASC, f.id ASC))[1] AS id_representante
    FROM filas f
