    ...
    <div style={{ width: "100%", maxWidth: 1040, margin: "0 auto", color: "#1a1a1a", padding: "0 8px 16px" }}>
      ...
      <section style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))", gap: 12, marginBottom: 12 }}>
        ...
        <div style={{ ...cardStyle, padding: 18 }}>
          {/* ── Enriched workshop details (dentro del 3er card para mantener 3 columnas) */}
                ...
                <div>
                  {workshopDetails.photoRef && (
                    <img
                      ...
                      alt="Foto del taller"
                      loading="lazy"
                      style={{ width: "100%", maxHeight: 140, objectFit: "cover", borderRadius: 8, marginBottom: 10, display: "block" }}
                    />
                  )}
