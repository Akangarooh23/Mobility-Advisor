...
function lasPuertas(hay, ahora = new Date()) {
  ...
  const puertas = [
     ...
     * revisiones es lo primero que pregunta quien compra y sube el precio; el
     * papel del seguro hace falta el día del traspaso.
     */
    {
      clave: 'seguro',
      nombre: 'El seguro',
      abierta: Number(hay.seguros || 0) > 0,
      falta: 'Sube la póliza o el recibo de tu seguro',
    },
    {
      clave: 'mantenimiento',
      nombre: 'El mantenimiento',
      abierta: Number(hay.mantenimientos || 0) > 0,
      falta: 'Sube alguna factura de las revisiones',
    },
  ];
