...
// El almacen de facturacion es un fichero del repositorio, y emitir una factura
// escribe en el. Una prueba no puede dejar un cliente inventado dentro: se
...
before(() => {
  try { almacenAntes = fs.readFileSync(ALMACEN, "utf8"); } catch { almacenAntes = null; }
...
after(() => {
  if (almacenAntes !== null) fs.writeFileSync(ALMACEN, almacenAntes);
