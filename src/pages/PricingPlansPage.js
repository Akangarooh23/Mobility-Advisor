  ...
  const copy = useMemo(() => {
    if (uiLanguage === "en") {
      return {
        ...
        guaranteeText: "No card required to start - cancel anytime - 30-day Plus trial",
        plusPerMonth: "/month",
    ...
    return {
      ...
      startPlus: "Probar 30 dias gratis",
      ...
      guaranteeText: "Sin tarjeta para empezar - Cancela cuando quieras - 30 dias gratis en Plus",
      plusPerMonth: "/mes",
