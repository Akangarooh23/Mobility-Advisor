/**
 * Le dice al orquestador de coches.com a quién tiene que llamar.
 *
 *   npm run enlaza-segmento-cochescom
 *
 * Busca «coches.com – Segmento (marca)» en la base de n8n, coge su id, lo escribe en
...
const GENERADOR = path.join(__dirname, "genera-scraper-cochescom.js");
const NOMBRE = "coches.com – Segmento (marca)";
...
if (!filas.length) {
  ...
  console.error("Impórtalo primero (n8n-workflows/cochescom-segmento.json) y vuelve a lanzar esto.");
  process.exit(1);
}
if (filas.length > 1) {
...
console.log("\n  Ahora reimporta n8n-workflows/cochescom-scraper-offers.json en n8n.");
