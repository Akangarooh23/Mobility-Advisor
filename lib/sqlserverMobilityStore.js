...
function addGarageVehicleByEmailSqlServer(email = "", vehicle = {}) {
  ...
  const documents = [
    ...sanitizeAttachmentArray(normalizedVehicle.documents),
...
function listGarageVehicleSummariesByEmailSqlServer(email = "") {
  const normalizedEmail = normalizeEmail(email);
  if (!normalizedEmail) {
    return [];
  }
...
function listGarageVehicleSummariesSqlServer(identityOrEmail = "") {
  return listGarageVehicleSummariesByEmailSqlServer(normalizeIdentityEmail(identityOrEmail));
}
...
module.exports = {
  ...
  listGarageVehicleSummariesByEmailSqlServer: listGarageVehicleSummariesSqlServer,
