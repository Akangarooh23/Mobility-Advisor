...
async function processStep(pool, session, phone, body, transcript) {
  ...
  if (step === 'buy_search_budget') {
    ...
    // `subFuente` no es texto de pantalla: se guarda y lo agrupa el ERP. Si
    // aquí empieza a poner popcar.tech, los informes parten en dos el mismo
    // origen sin que nadie se entere. Se cambia el día que se migre allí.
