...
// Aquí además el lote es aún más corto que en los otros: un HEAD a coches.com
// tarda 862 ms, el triple que en Autocasión y siete veces AutoScout24.
//
...
const CRON = "5 veces/día (9:55 a 22:55)";
const nodos = [
  ...
  { parameters: { rule: { interval: [{ field: "cronExpression", expression: "0 55 9,13,16,20,22 * * *" }] } },
