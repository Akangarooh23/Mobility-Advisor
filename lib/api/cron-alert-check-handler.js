...
const APP_BASE_URL = (process.env.APP_BASE_URL || "https://carswiseai.com").replace(/\/$/, "");
  ...
  <div style="max-width:580px;margin:0 auto;padding:32px 16px;">
    ...
    <div style="text-align:center;margin-top:28px;padding-top:20px;border-top:1px solid #e2e8f0;">
      ...
      <p style="font-size:11px;color:#94a3b8;margin:16px 0 0;line-height:1.6;">
        Recibes este email porque tienes alertas activas en CarsWise.<br>
...
async function sendEmail(to, subject, html) {
  ...
  const from =
    ...
    "CarsWise <noreply@carswiseai.com>";
