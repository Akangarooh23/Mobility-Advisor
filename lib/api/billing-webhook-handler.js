...
async function sendInvoiceEmail({ to, pdfBuffer, invoiceRecord }) {
  ...
  const html = `
    <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:32px 24px;color:#111111">
      <div style="background:#111111;padding:20px 24px;border-radius:8px 8px 0 0;border-bottom:3px solid #FFC400">
        <span style="font-size:18px;font-weight:800;letter-spacing:-0.5px"><span style="color:#FFC400">Pop</span><span style="color:#fff">Car</span></span>
      </div>
