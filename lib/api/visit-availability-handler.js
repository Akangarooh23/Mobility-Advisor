...
async function sendBookingEmails(booking) {
  ...
  // ── Email al comprador ──────────────────────────────────────────────────
  const buyerHtml = emailBase("Cita confirmada", `
    <h1>✅ Cita confirmada</h1>
    <p class="sub">Tu visita está reservada. Guarda esta fecha en tu calendario.</p>
    <div class="card">
  ...
  sends.push(sendEmail({
    ...
    subject: `✅ Cita confirmada — ${vehicle} — ${dateStr}`,
    html: buyerHtml,
