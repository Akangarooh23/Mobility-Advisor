...
<body><div class="wrap">
  ...
  <div class="footer">${MARCA.nombre} · <a href="${MARCA.sitioUrl}" style="color:#94a3b8">${MARCA.sitio}</a></div>
</div></body></html>`;
}
...
async function sendBookingEmails(booking, opts = {}) {
  ...
  const opsHtml = emailBase("Nueva cita recibida", `
    ...
    <p class="sub">Un usuario ha reservado una visita para un vehículo de ${MARCA.nombre}.</p>
    <div class="card">
