...
/**
 * Lo que paga el cliente por el servicio: la base y su IVA.
 *
 * Es lo que se enseña en la ficha, porque a un particular los precios se le
 * dicen con el impuesto dentro. Lo que ganamos es la base, no esto.
 */
const FEE_POPCAR = Math.round(FEE_POPCAR_BASE * (1 + IVA_SERVICIO));
