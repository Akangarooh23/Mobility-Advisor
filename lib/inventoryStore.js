...
async function getMarketPriceSnapshot(options = {}) {
  ...
  const kmAdvantagePct = mileage != null && computeOffers.length > 0
    ? Math.round(computeOffers.filter((o) => o.mileage > mileage).length / computeOffers.length * 100)
    : null;
