...
describe("los mismos números en el flujo que los calcula", () => {
  ...
  test("el papeleo sigue siendo 600, partido en dos en el SQL", () => {
    // En el flujo siguen escritos como 400 + 200 porque así se pusieron de
    // prueba. Aquí ya tienen nombre; el día que la gestoría dé su precio, se
    // sustituyen por uno solo que salga de su tarifa.
    assert.equal(400 + 200, PAPELEO_ESTIMADO);
  });
