                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        gap: 10,
                        border: isActive ? "1px solid var(--gris-300)" : "1px solid #ece8df",
                        borderRadius: 10,
                        background: isActive ? "var(--gris-50)" : "#fafaf9",
                        padding: "10px 12px",
                        cursor: "pointer",
                        textAlign: "left",
                      }}
                    ...
                    return (
                      <button
                        ...
                        style={{
                          ...
                          color: isSelected
                            ? (hasScheduledAlerts ? "#166534" : hasPendingAlerts ? "#1e40af" : "var(--gris-700)")
                            : normalColor,
                          cursor: "pointer",
                          position: "relative",
                        }}
