...
async function generateInvoicePdf(invoiceRecord, userProfile = {}) {
  ...
  dt(facturaLabel, rtx(facturaLabel, 50, 22, rb), 50, 22, rb, c("#0f172a"));
  const numLabel = `N\xba: ${invoiceRecord.number || invoiceRecord.id}`;
  dt(numLabel, rtx(numLabel, 80, 9.5, ri), 80, 9.5, ri, c("#475569"));
  const fechaLabel = `Fecha: ${date}`;
  dt(fechaLabel, rtx(fechaLabel, 94, 9.5, ri), 94, 9.5, ri, c("#475569"));
  ln(50, 115, 545, 115);
    ...
    <div style="font-family:Inter,Arial,sans-serif;max-width:600px;margin:0 auto;color:#1C2B33;">
      ...
      <div style="padding:28px 32px;">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px;margin-bottom:24px;">
          ...
          <div style="background:#fff;border:1px solid #ECEEF0;border-radius:10px;padding:14px;text-align:center;">
            <div style="font-size:20px;font-weight:800;color:#137370;">–</div>
            <div style="font-size:11px;color:#6B7780;margin-top:4px;">Días medios de venta</div>
          </div>
          <div style="background:#fff;border:1px solid #ECEEF0;border-radius:10px;padding:14px;text-align:center;">
