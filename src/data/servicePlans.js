...
export const SERVICE_PLANS = [
  ...
  },
  {
    ...
    monthlyPrice: "79",
    accent: "var(--gris-400)",
    background: "rgba(150,150,143,0.10)",
    border: "rgba(150,150,143,0.28)",
    badge: "Más equilibrado",
    badgeEn: "Most balanced",
    badgeBackground: "rgba(150,150,143,0.2)",
    highlights: [
      "Todo lo de Bronce",
  ...
  },
  {
    ...
    monthlyPrice: "299",
    accent: "var(--gris-300)",
    background: "rgba(207,207,200,0.10)",
    border: "rgba(207,207,200,0.30)",
    badge: "Integral",
    badgeEn: "Comprehensive",
    badgeBackground: "rgba(207,207,200,0.2)",
    highlights: [
      "Todo lo de Oro",
