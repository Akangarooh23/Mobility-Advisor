...
function buildReportData(vehicle, national, damageFactor = null, referenceDate = null) {
  ...
  return {
    ...
    usageUsedDefault: mkt.usageUsedDefault ?? false,
    ...
    : [
        {
          ...
          n: rd.usageUsedDefault
            ? `${vKm != null ? new Intl.NumberFormat("es-ES").format(vKm) + " km · " : ""}${vAge != null ? vAge + " anos · " : ""}estimado por segmento`
            : (rd.usageImpact > 50  ? `Km y antiguedad favorables vs. mercado`
               : rd.usageImpact < -50 ? `Km elevado o antiguedad alta vs. mercado`
