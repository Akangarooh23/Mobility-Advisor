 ...
 *
 * **El transporte llega hasta Madrid, no hasta su casa.** Lo incluido es traer
 * el coche de Alemania a nuestras instalaciones, que es donde tiene que estar
 * para la ITV de homologación y para matricularlo. Llevárselo desde ahí es un
 * servicio y se contrata aparte, como el seguro o el reacondicionado. La línea
 * lo dice con esas palabras: «Transporte desde Alemania» decía de dónde y no
 * decía hasta dónde, y quien la leía entendía que se lo llevaban a casa.
 *
 * Entrega, reacondicionado y seguro **no están aquí**: se contratan aparte y
 * **no entran en la fianza**. Decirlo es lo que evita que el precio parezca
 * crecer después.
 *
...
function desgloseParaElCliente(precioAleman, precioEspanol) {
  ...
  const lineas = [
    ...
    { concepto: "Transporte hasta nuestras instalaciones", importe: TRANSPORTE },
    {
  ...
  return {
    ...
    aparte: ["Entrega en tu domicilio", "Seguro", "Reacondicionado, si hace falta"],
