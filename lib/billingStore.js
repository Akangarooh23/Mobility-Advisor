...
async function getUserMobilityDataByEmailPostgres(email = "") {
  const [
    ...
    listGarageVehiclesByEmailPostgres(email),
    listAppointmentsByEmailPostgres(email),
    listMaintenancesByEmailPostgres(email),
    listInsurancesByEmailPostgres(email),
    listValuationsByEmailPostgres(email),
    listVehicleStatesByEmailPostgres(email),
    listSavedOffersByEmailPostgres(email),
    listSolicitudesByEmailPostgres(email),
    countGarageVehiclesByEmailPostgres(email),
  ]);
