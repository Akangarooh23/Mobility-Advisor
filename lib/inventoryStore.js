...
async function getMarketPriceSnapshot(options = {}) {
  ...
  // Data-driven price adjustments via linear regression on comparables
  const kmImpact  = computeKmImpact(offers, mileage, marketMedian, priceField);
  const ageImpact = computeAgeImpact(offers, year,    marketMedian, priceField);
