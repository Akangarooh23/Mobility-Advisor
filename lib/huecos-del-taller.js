 ...
 *
 * GEMELAS DE `apps/api/src/db/schema.ts` EN EL ERP, donde está el mismo
 * `CREATE TABLE IF NOT EXISTS`: aquí se reservan las horas y allí se cierran
 * los días. Las dos declaraciones tienen que decir lo mismo; la que corra
 * primero crea y la otra no hace nada. Si se toca una, se toca la otra.
 */
const ASEGURA = `
