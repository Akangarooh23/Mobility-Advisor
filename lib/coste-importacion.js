 ...
 */
const FEE_POPCAR = 2999;

/**
 * Por debajo de este precio no se importa.
 *
 * Con un fee de 2.999 €, un coche de 5.000 € sale por 8.000 antes del impuesto:
 ...
 * una sola cosa, saber si el fee da o no da. Hoy: 2.999 de fee menos 1.343 de
 * coste, 1.656 € por coche antes de nuestro tiempo.
 *
...
/** Lo que nos queda del fee después de los costes que sabemos. */
...
function desgloseParaElCliente(precioAleman, precioEspanol) {
  ...
  const lineas = [
    ...
    { concepto: "Servicio PopCar", importe: FEE_POPCAR, aQuien: "a nosotros" },
    {
