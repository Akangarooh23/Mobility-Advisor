/**
 * GET /api/user-preferences  – obtiene preferencias del usuario autenticado
 * PUT /api/user-preferences  – guarda preferencias del usuario autenticado
 */
