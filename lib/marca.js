...
const MARCA = {
  ...
  // silencio, rebota. popcar.com.es lo esta desde el 7 de septiembre de 2026,
  // con el SPF y la clave DKIM en la zona de Vercel, que es quien lleva su DNS.
  //
  // Esta direccion no recibe, y es a proposito: popcar.com.es no tiene MX.
  // Quien le de a Responder acaba donde diga `respuestaA()`, que apunta al
  // unico buzon de la casa que si recibe. Sin esa cabecera, la respuesta de un
  // cliente a su recordatorio de cita se perderia sin rebotar a ningun sitio.
  remitentePorDefecto: "PopCar <notifications@popcar.com.es>",
