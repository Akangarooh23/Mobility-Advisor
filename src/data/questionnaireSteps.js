export const STEPS = [
    ...
    fields: {
      horizonte_tenencia: {
        ...
        options: [
          ...
          { value: "2_3", label: "2 - 3 años" },
          { value: "3_5", label: "3 - 5 años" },
          { value: "5_7", label: "5 - 7 años" },
          { value: "mas_7", label: "Más de 7 años" },
      ...
      antiguedad_vehiculo_buscada: {
        ...
        selectionMode: "multi",
        options: [
          { value: "cero_anos", label: "0 años (nuevo)" },
          { value: "0_2_anos", label: "0 - 2 años" },
          { value: "2_4_anos", label: "2 - 4 años" },
          { value: "4_7_anos", label: "4 - 7 años" },
  ...
  },
  {
    ...
    type: "cards",
    options: [
      { value: "menos_10k", label: "Menos de 10.000 km", desc: "Uso muy local" },
      { value: "10k_20k", label: "10.000 - 20.000 km", desc: "Uso moderado" },
      { value: "20k_35k", label: "20.000 - 35.000 km", desc: "Uso frecuente" },
      { value: "mas_35k", label: "Más de 35.000 km", desc: "Alto kilometraje" },
    ],
  },
  {
    id: "entorno_uso",
  ...
  },
  {
    ...
    block: "Prioridades",
    blockIcon: "🎛️",
    question: "Ordena qué criterios quieres que respetemos más en tus ofertas",
    subtitle: "Asigna un número del 1 al 5: 5 significa que ese criterio debe pesar mucho más en las ofertas finales.",
    type: "score_weights",
    metrics: [
      ...
      { key: "antiguedad_vehiculo_buscada", label: "Antigüedad deseada del coche", icon: "🕒" },
