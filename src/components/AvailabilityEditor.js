...
const styles = {
  wrap:        { border: "1.5px solid var(--gris-200)", borderRadius: 12, padding: "18px 20px", background: "#fff", marginBottom: 20 },
  title:       { fontSize: 15, fontWeight: 700, color: "var(--gris-900)", marginBottom: 4 },
  subtitle:    { fontSize: 13, color: "var(--gris-500)", marginBottom: 12 },
  tabs:        { display: "flex", gap: 0, marginBottom: 16, borderBottom: "1.5px solid var(--gris-200)" },
  tab:         { background: "none", border: "none", borderBottom: "2.5px solid transparent", padding: "7px 16px", fontSize: 13, fontWeight: 600, color: "var(--gris-400)", cursor: "pointer", marginBottom: -1.5 },
  tabActive:   { color: "var(--gris-900)", borderBottomColor: "var(--gris-900)" },
  formBlock:   { marginBottom: 12 },
  addRow:      { display: "flex", gap: 10, alignItems: "flex-end", flexWrap: "wrap" },
  field:       { display: "flex", flexDirection: "column", gap: 4 },
  label:       { fontSize: 11, fontWeight: 600, color: "var(--gris-500)" },
  input:       { border: "1.5px solid var(--gris-200)", borderRadius: 8, padding: "8px 10px", fontSize: 13, color: "var(--gris-900)", outline: "none", minWidth: 120 },
  addBtn:      { background: "var(--gris-900)", color: "#fff", border: "none", borderRadius: 8, padding: "9px 18px", fontSize: 13, fontWeight: 700, cursor: "pointer", whiteSpace: "nowrap" },
  dayRow:      { display: "flex", gap: 6, alignItems: "center", flexWrap: "wrap", marginTop: 2 },
  dayBtn:      { width: 34, height: 34, border: "1.5px solid var(--gris-200)", borderRadius: 8, background: "var(--gris-50)", color: "var(--gris-500)", fontSize: 12, fontWeight: 700, cursor: "pointer" },
  dayBtnOn:    { background: "var(--gris-900)", color: "#fff", borderColor: "var(--gris-900)" },
  presetSep:   { color: "var(--gris-200)", fontSize: 18, margin: "0 2px" },
  presetBtn:   { background: "none", border: "1.5px solid var(--gris-200)", borderRadius: 8, padding: "4px 10px", fontSize: 12, color: "var(--gris-500)", cursor: "pointer", whiteSpace: "nowrap" },
  previewRow:  { display: "flex", alignItems: "center", gap: 12, marginTop: 14 },
  previewText: { fontSize: 13, color: "var(--gris-500)", flex: 1 },
  ...
  hint:        { color: "var(--gris-400)", fontSize: 13, padding: "8px 0" },
  slotGrid:    { display: "flex", flexDirection: "column", gap: 6, marginTop: 8, maxHeight: 260, overflowY: "auto", paddingRight: 2 },
  groupLabel:  { fontSize: 11, fontWeight: 700, color: "var(--gris-400)", textTransform: "uppercase", letterSpacing: ".5px" },
  slotRow:     { display: "flex", alignItems: "center", gap: 8, background: "var(--gris-50)", borderRadius: 8, padding: "8px 12px" },
