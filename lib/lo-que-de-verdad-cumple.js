...
function porQueNoVale(oferta, limites) {
  ...
  if (limites.carroceria) {
    ...
    if (suya) {
      ...
      /*
       * Sin dato, se mira el nombre.
       *
       * El Audi TT Coupe no tiene carroceria en la base: lo unico que lo
       * delata es como se llama. Se descarta solo si el nombre dice que es de
       * otro tipo; si no dice nada, pasa.
       */
