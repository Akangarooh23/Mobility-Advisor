...
async function handleRequest(req, res) {
   ...
   *
   * Lo que falta aquí es un freno por ritmo: sin él, esto se puede llamar mil
   * veces y mandar mil correos al vendedor. Va con el limitador del login, que
   * es el mismo problema y merece una sola solución.
   */
