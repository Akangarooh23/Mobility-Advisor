...
const {
  TRANSPORTE, PAPELEO_ESTIMADO, sqlTipoDelImpuesto, impuestoDeMatriculacion,
...
describe("lo que paga el cliente", () => {
  ...
  test("el coche, el fee y el impuesto: nada más", () => {
    ...
    assert.equal(precioPuestoAqui(18000, 24000), 18000 + 3000 + impuestoDeMatriculacion(18000));
  });
