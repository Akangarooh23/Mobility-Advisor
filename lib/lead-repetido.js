 ...
 *
 * Mientras esté en cualquier otro —pendiente, contactado, en curso— la
 * solicitud sigue viva y no hace falta una segunda.
 */
const YA_NO_ESPERA = ["Vendido", "Cancelado", "Descartado", "No interesado", "Perdido"];
