...
const MARCA = {
  ...
  // silencio, rebota. popcar.com.es todavía no lo está —le faltan los TXT de
  // SPF y DKIM, que ahora se ponen en Vercel porque el DNS lo lleva él—, así
  // que el remitente se queda en popcar.tech, que sí lo está. Moverlo antes de
  // verificar deja sin salir los recordatorios de citas y los avisos de
  // alertas, y sin que nadie se entere: el rebote ocurre del lado de Resend.
